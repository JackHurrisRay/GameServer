	...
	public BASE_PROTOCAL_MSG
{
	...
	{
		//key值利用微信登录ID
		initializeParam(3, JSON_PLAYER_KEY, JSON_PLAYER_IMG, JSON_PLAYER_NICKNAME);
	}
};
	...
	public BASE_PROTOCAL_MSG
{
	...
	{
		initializeParam(5, JSON_ROOM_ID, JSON_ROOM_RANDKEY, JSON_ROOM_PLAYERCOUNT, JSON_BASESCORE, JSON_ROOM_MAX_AROUND);
	}
